...
# --- FUNCIÓN PARA DETECTAR SI LA NOTICIA ESTÁ RELACIONADA CON SECUESTROS Y DESCARTAR "El Mayo" o "El Mayo Zambada" ---
...
def es_noticia_de_secuestro_bert(titulo, descripcion, noticia):
    ...
    # Descartamos la noticia si menciona a "El Mayo Zambada" o "El Mayo"
    if "El Mayo Zambada" in texto_completo or "El Mayo" in texto_completo:
        return False, "Noticia descartada por mencionar a El Mayo o El Mayo Zambada."
...
# --- FUNCIÓN PARA OBTENER LOS REGISTROS FILTRADOS DE TÍTULO, DESCRIPCIÓN Y NOTICIA ---

def obtener_noticias():
    conexion = conectar_bd()
    try:
        with conexion.cursor() as cursor:
            # Consulta para excluir registros que mencionen secuestro en título o descripción
            sql = """
