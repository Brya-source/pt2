    ...
    for tipo, palabras_clave in tipos_secuestro.items():
        for palabra in palabras_clave:
            if palabra in texto_normalizado:
                ...
                if tipo == 'Secuestro familiar' and any(pol in texto_normalizado for pol in ['suplente', 'senador', 'diputado', 'gobernador', 'presidente']):
                    categorias_identificadas.add('Secuestro político')
                    justificaciones.append(f"Detectado '{palabra}' y relación política en el texto.")
                else:
                    categorias_identificadas.add(tipo)
                    justificaciones.append(f"Detectado '{palabra}' en el texto.")
