...
localidades = {
    ...
    # Puedes agregar más localidades aquí.
}
...
def agregar_campos():
    try:
        ...
        cursor.execute("SHOW COLUMNS FROM extracciones LIKE 'tipo_localidad'")
        resultado_tipo_localidad = cursor.fetchone()
        ...
        if not resultado_tipo_localidad:
            cursor.execute("ALTER TABLE extracciones ADD COLUMN tipo_localidad VARCHAR(255)")
            print("Campo 'tipo_localidad' agregado.")
...
def procesar_noticias():
    try:
        ...
        sql = "SELECT id, noticia_corregida FROM extracciones WHERE relacion_bart3='Sí'"
        cursor.execute(sql)
        ...
        for noticia in noticias:
            ...
            if pais or estado or municipio or ciudad:
                ...
                print(f"No se encontraron lugares válidos en la noticia {noticia_id}")
